...
if len(compression_data) >= 2:
    ...
    ax_save.set_xlabel('compression type', fontsize=13, fontweight='bold')
    ax_save.set_ylabel('time (s)', fontsize=13, fontweight='bold')
    ax_save.set_xticks(x_pos)
    ax_save.set_xticklabels(compression_types, fontsize=11, fontweight='bold')
    ...
    ax_load.set_xlabel('compression type', fontsize=13, fontweight='bold')
    ax_load.set_ylabel('time (s)', fontsize=13, fontweight='bold')
    ax_load.set_xticks(x_pos)
    ax_load.set_xticklabels(compression_types, fontsize=11, fontweight='bold')
    ...
    ax_size.set_xlabel('compression type', fontsize=13, fontweight='bold')
    ax_size.set_ylabel('file size (gb)', fontsize=13, fontweight='bold')
    ax_size.set_xticks(x_pos)
    ax_size.set_xticklabels(compression_types, fontsize=11, fontweight='bold')
    ...
    ax.set_xlabel('Compression Type', fontsize=13, fontweight='bold')
    ax.set_ylabel('Time (s)', fontsize=13, fontweight='bold')
    ax.set_xticks(x_pos)
    ax.set_xticklabels(compression_types, fontsize=11, fontweight='bold')
