...
if len(concurrency_data) >= 2:
    ...
    plt.tight_layout()
    save_file = data_dir / "concurrency_comparison_save.png"
    ...
    plt.tight_layout()
    load_file = data_dir / "concurrency_comparison_load.png"
    ...
    plt.tight_layout()
    size_file = data_dir / "concurrency_comparison_size.png"
...
print("="*70)
print(f"\noutput files:")
print(f"  - {data_dir}/concurrency_comparison.png (combined)")
print(f"  - {data_dir}/concurrency_comparison_save.png (save time)")
print(f"  - {data_dir}/concurrency_comparison_load.png (load time)")
print(f"  - {data_dir}/concurrency_comparison_size.png (file size)")
